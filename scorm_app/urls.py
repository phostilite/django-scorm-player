...
from .views import UserViewSet, CourseViewSet, ScormPackageViewSet, UserCourseRegistrationViewSet, SCORMAttemptViewSet, SCORMElementViewSet, SCORMAPIViewSet, ReportingViewSet, launch_scorm
